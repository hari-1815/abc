<?php 
	...
	$fetch_regid=$functionObj->generate_regid();
	...
	if(isset($_POST['add'])){
		$save=$functionObj->save_user($_SESSION['user_id']); 
		if(!$save){
			$error = true;
		}
	}
				...
				<div class="main-panel">
					<div class="content-wrapper">
						<div class="page-header">
							<h3 class="page-title">Add Persons</h3>
						...
						<div class="row">
							<div class="col-12 grid-margin">
								<div class="card">
									<div class="card-body">
										<p class="card-description" style="color: #3b3b79"><b>Add Personal Info</b></p>
										<div class="row">
											<div class="col-md-6">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
													  <input type="number" class="form-control" id="user_aadhar" name="user_aadhar" onchange="check_aadhar(this.value)"/>
										...
										<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="text" class="form-control" id="user_father" name="user_father"  />
													</div>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="text" class="form-control" id="user_mother" name="user_mother" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<select class="form-control" id="user_marital_status" name="user_marital_status" onchange="enable_spouse(this.value)" >
											...
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="text" class="form-control" id="user_spouse" name="user_spouse" value="None" />
													</div>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="number" class="form-control" id="user_no_of_dependant" name="user_no_of_dependant"   />
													</div>
												</div>
											</div>
										</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<textarea class="form-control" name="user_per_address" id="user_per_address"></textarea>
														</div>
													</div>
												</div>
												<div class="col-md-6">
									...
									<div class="col-sm-9">
										<select class="form-control" id="user_place" name="user_place" onchange="load_evdData(this.value)">
											...
											<div class="row">
												...
												<div class="col-md-6">
													...
													<label class="col-sm-3 col-form-label">District</label>
														<div class="col-sm-9">
															<select class="form-control" id="user_per_district" name="user_per_district" onchange="load_per_city(this.value)">
												...
												<div class="col-md-6">
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<input type="number" class="form-control" id="user_per_postcode" name="user_per_postcode" />
														</div>
													</div>
											</div>
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="number" class="form-control" id="user_years" name="user_years" />
													</div>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
											  <div class="form-group row">
												...
												<div class="col-sm-9">
												  <input type="text" class="form-control" id="user_per_landmark" name="user_per_landmark" />
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="number"  class="form-control"  id="user_loan_amount" name="user_loan_amount"  />
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-3 col-form-label">Start Date</label>
												<div class="col-sm-9">
													<input type="Date" class="form-control"  placeholder="" id="user_start_date" name="user_start_date"  />
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="number" class="form-control"   id="user_no_of_weeks" name="user_no_of_weeks"  />
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-3 col-form-label">End Date</label>
												<div class="col-sm-9">
													<input type="date" class="form-control"   placeholder="" id="user_end_date" name="user_end_date"  />
												</div>
...
<table id="order-listing" class="table" >
		...
		<tr>
		    ...
		    <tr><th>Week 30</th><td><input type="date" id="week30_dt" name="week30_dt"><td><input type="number" id="week30" name="week30"></td></tr>
									...
									<div>
										<button type="submit" name="add" class="btn btn-primary mr-2" value="submit">Submit</button>
