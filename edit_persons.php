				...
				<div class="main-panel">
					<div class="content-wrapper">
						<div class="page-header">
							<h3 class="page-title">Edit Persons</h3>
						...
						<div class="row">
							<div class="col-12 grid-margin">
								<div class="card">
									<div class="card-body">
										<p class="card-description" style="color: #3b3b79"><b>Edit Personal Info</b></p>
										<div class="row">
											<div class="col-md-6">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="number" class="form-control" id="user_mobile" name="user_mobile" value="<?php echo $row['user_mobile'];?>" />
											...
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
													  <input type="number" class="form-control" id="user_aadhar" name="user_aadhar" value="<?php echo $row['user_aadhar'];?>" onchange="check_aadhar(this.value)"/>
										...
										<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="text" class="form-control" id="user_father" name="user_father" value="<?php echo $row['user_father'];?>"/>
													</div>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="text" class="form-control" id="user_mother" name="user_mother" value="<?php echo $row['user_mother'];?>"/>
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<select class="form-control" id="user_gender" name="user_gender" value="<?php echo $row['user_gender'];?>">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
												<select class="form-control" id="user_marital_status" name="user_marital_status" value="<?php echo $row['user_marital_status'];?>" onchange="enable_spouse(this.value)" >
											...
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="text" class="form-control" id="user_spouse" name="user_spouse" value="<?php echo $row['user_spouse'];?>"  />
													</div>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="number" class="form-control" id="user_no_of_dependant" name="user_no_of_dependant" value="<?php echo $row['user_no_of_dependant'];?>"   />
													</div>
												</div>
											</div>
										</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<input type="text" class="form-control" name="user_per_address" id="user_per_address" value="<?php echo $row['user_per_address'];?>">
														</div>
													</div>
												</div>
												<div class="col-md-6">
									...
									<div class="col-sm-9">
										...
										<option value="<?php echo $row['loan_place_id'];?>"><?php echo $row['loan_place_name'];?></option>														
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<input readonly type="text" class="form-control" value="TamilNadu" id="user_per_state" name="user_per_state" value="<?php echo $row['user_per_state'];?>" />
														</div>
													</div>
												</div>
												<div class="col-md-6">
													...
													<label class="col-sm-3 col-form-label">District</label>
														<div class="col-sm-9">
															<select class="form-control" id="user_per_district" name="user_per_district"  value="<?php echo $row['user_per_district'];?>"onchange="load_per_city(this.value)">
												...
												<div class="col-md-6">
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<input type="number" class="form-control" id="user_per_postcode" name="user_per_postcode" value="<?php echo $row['user_per_postcode'];?>" />
														</div>
													</div>
												</div>
											</div>
										<div class="row">
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<select class="form-control" id="user_residential" name="user_residential" value="<?php echo $row['user_residential'];?>">
											...
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="number" class="form-control" id="user_years" name="user_years" value="<?php echo $row['user_years'];?>"/>
													</div>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
											  <div class="form-group row">
												...
												<div class="col-sm-9">
												  <input type="text" class="form-control" id="user_per_landmark" name="user_per_landmark" value="<?php echo $row['user_per_landmark'];?>" />
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="number"  class="form-control"  id="user_loan_amount" name="user_loan_amount" value="<?php echo $row['user_loan_amount'];?>" />
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-3 col-form-label">Start Date</label>
												<div class="col-sm-9">
													<input type="Date" class="form-control"  placeholder="" id="user_start_date" name="user_start_date" value="<?php echo $row['user_start_date'];?>"  />
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="number" class="form-control"   id="user_no_of_weeks" name="user_no_of_weeks" value="<?php echo $row['user_no_of_weeks'];?>"  />
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-3 col-form-label">End Date</label>
												<div class="col-sm-9">
													<input type="date" class="form-control"   placeholder="" id="user_end_date" name="user_end_date" value="<?php echo $row['user_end_date'];?>" />
												</div>
											</div>
									</div>
									<div class="col-md-6">
									...
									<div class="col-sm-9">
										<select class="form-control" id="user_day" name="user_day" onchange="load_evdData(this.value)">
									...
									<div class="col-sm-9">
										<select class="form-control" id="user_session" name="user_session" onchange="load_evdData(this.value)">
...
<table id="order-listing" class="table" >
		...
		<tr>
		    ...
		    <tr><th>Week 30</th><td><input type="date" id="week30_dt" name="week30_dt"><td><input type="number" id="week30" name="week30"></td></tr>
										...
										<button type="submit" name="update" class="btn btn-primary mr-2" value="submit">Submit</button>
